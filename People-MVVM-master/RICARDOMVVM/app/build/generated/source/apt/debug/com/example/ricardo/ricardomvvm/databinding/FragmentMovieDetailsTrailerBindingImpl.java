...
public class FragmentMovieDetailsTrailerBindingImpl extends FragmentMovieDetailsTrailerBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.rv_fragment_movie_details_trailer, 1);
    }
    // views
    // variables
    // values
    ...
    public FragmentMovieDetailsTrailerBindingImpl(@Nullable android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 2, sIncludes, sViewsWithIds));
    }
    private FragmentMovieDetailsTrailerBindingImpl(android.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0
            , (android.support.constraint.ConstraintLayout) bindings[0]
            , (android.support.v7.widget.RecyclerView) bindings[1]
            );
        this.relativeLayoutFragmentMovieDetailsTrailer.setTag(null);
        setRootTag(root);
        // listeners
        invalidateAll();
    }
